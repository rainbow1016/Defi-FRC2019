...
public class OI {
  ...
  /*
   * TODO placer les commande suivante avec un bouton ou un axis. -TranfererBallon
   * -SetHauteurIntake (les bons presets) SetHauteurElevateur (les bons presets)
   * -DeposerHatch -PrendreBallonIntake -MonterIntake -DescendreIntake
   * -MonterElevateur -DescendreElevateur -LancerBallon
   * 
   * 
   */
